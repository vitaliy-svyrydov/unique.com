...
@endif
        ...
        @foreach($portfolios as $portfolio)
            <!-- Portfolio Item -->
            <div style="border-radius: 20px; pxposition: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four {{ $portfolio->filter }} isotope-item">
                <div class="portfolio_img">{{ Html::image('assets/img/'.$portfolio->images,'',['style' => 'border-radius: 20px']) }}
                </div>
        ...
        <div class="team_section clearfix">
            ...
            <div class="team_area">
                <div class="team_box wow fadeInDown delay-0{{ $key*3 + 3 }}s">
                    <div class="team_box_shadow" style="border-radius: 6px"><a href="javascript:void(0)"></a></div>
...
<footer class="footer_wrapper" id="contact">
                ...
                <div class="col-lg-4 wow fadeInLeft">
                    <div class="contact_info">
                        <div class="detail">
                            ...
                            <p>252, Some street, Kharkov, Ukraine</p>
                        </div>
                        <div class="detail">
                            <h4>call us</h4>
                            <p>+1 234 567890</p>
                        ...
                        <div class="detail">
                            <h4>Email us</h4>
                            <p>svyrydov.vitaliy@gmail.com</p>
                        </div>
                    </div>
                    ...
                    <ul class="social_links">
                        <li class="twitter animated bounceIn wow delay-02s"><a href="https://twitter.com"><i class="fa fa-twitter"></i></a></li>
                        <li class="facebook animated bounceIn wow delay-03s"><a href="https://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
                        <li class="pinterest animated bounceIn wow delay-04s"><a href="https://www.pinterest.com"><i class="fa fa-pinterest"></i></a></li>
                        <li class="gplus animated bounceIn wow delay-05s"><a href="https://plus.google.com"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                </div>
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2018,    Designed by <a href="https://vk.com/vitaliysvyrydov">Vitaliy Svyrydov</a> </span> </div>
    </div>
</footer>